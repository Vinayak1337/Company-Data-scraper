# Legacy Django Render Notes

The current v2 Render Blueprint lives at the repository root in `render.yaml`. See `docs/deployment.md` for the maintained split frontend/backend deployment flow.

These notes are retained for the legacy Django-only backend.
